...
class AITracker:
    ...
    def startLoop(self):
        ...
        # This json file is sent to DepthAI. 
        # It communicates what options you'd like to enable and what model you'd like to run.  
        ...
        print("RECEIVED ROTATION {} -> {} -> {}".format(type(intrinsic_left), 
                                                        type(rotation_matrix), 
                                                        rotation_matrix))

        print("RECEIVED TRANSLATION {}".format(translation_matrix))
        print("MAtrix type {}, shape {}".format(type(intrinsic_left), 
                                                intrinsic_left.shape))

        R1, R2, projection_left, projection_right, Q, roi1, roi2 = cv2.stereoRectify(intrinsic_left, 
                                                                                    distortion_left,
                                                                                    intrinsic_right, 
                                                                                    distortion_right,
                                                                                    (1280,720),
        ...
        while self.runThread:
            ...
            # there are nnet (Neural NETwork) packets which have additional functions for NNet result interpretation
